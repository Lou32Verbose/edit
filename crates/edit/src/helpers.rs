...
pub use stdext::{
    AsciiStringHelpers, GIBI, GIGA, KIBI, KILO, MEBI, MEGA, MetricFormatter, ReplaceRange, minmax,
    opt_ptr, opt_ptr_eq, slice_as_uninit_mut, slice_as_uninit_ref, slice_copy_safe,
    str_from_raw_parts,
};
